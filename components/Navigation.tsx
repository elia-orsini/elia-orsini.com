  ...
  return (
    <>
      <div className="z-30 flex min-h-screen w-screen flex-col overflow-clip md:flex-row">
        <div className="z-40 flex h-full w-full flex-col md:fixed md:h-screen md:w-max md:pl-20 md:pr-10">
          <Link href="/" passHref>
            <div className="mx-auto mt-10">
              <svg
                id="Logo"
                className="mx-auto w-16 md:-ml-4 md:w-20"
                data-name="Logo"
          ...
          <div className="mx-auto mt-3 flex w-max flex-row gap-x-14 space-y-2 text-xl md:mt-10 md:flex-col md:gap-x-0 md:text-left">
            {/* {path === "design" ? (
              <p className="ml-0 mt-2 underline hover:cursor-default md:mx-0">design</p>
            ) : (
        ...
        <div className="main-content z-30 flex w-full max-w-[110rem] flex-col md:pl-44 lg:pl-60">
          {children}
        </div>
      </div>
    </>
